...
tests = [ 
    ...
    # PC5..PC0 = 1 && PC7 = 1;
    {'description': 'Fuel is full (PINA is 15) and seatbelt is off',
    'steps': [ {'inputs': [('PINA', 0x3F)], 'iterations': 5 } ],
    'expected': [('PORTC', 0xBF)], # 1011 1111
    },

    {'description': 'Fuel is low (PINA is 1) and seatbelt is off',
    'steps': [ {'inputs': [('PINA', 0x31)], 'iterations': 5 } ],
    'expected': [('PORTC', 0xE0)], # 1110 0000
    },
