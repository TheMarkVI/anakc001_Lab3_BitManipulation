 ...
 *      3:
 *         In addition to 2,
 *         - PA4 is 1 if a key is in ignition
 *         - PA5 is 1 if driver is seated
 *         - PA6 is 1 if driver seatbelt is fastened
 *         - PC7 is 1 if (PA4 && PA5 && !PA6)
 *
...
int main(void) {
    ...
    unsigned char seatBeltSensor = 0x00;
    ...
    while (1) {
        ...
        PORTC = fuelSensor | seatBeltSensor;
    }
    return 1;
}
